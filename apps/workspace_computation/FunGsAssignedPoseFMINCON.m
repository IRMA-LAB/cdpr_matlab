function [tension_vector,tension_matrix,vector,matrix] = FunGsAssignedPoseFMINCON(cdpr_p,act_vars,un_act_vars,varargin)
...
tension_vector = -cdpr_v.tension_vector;
