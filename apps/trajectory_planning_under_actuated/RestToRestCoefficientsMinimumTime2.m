function [output] = RestToRestCoefficientsMinimumTime2(cdpr_p,cdpr_v,...
...
for i = 1:sim_data.pNumber-1
    ...
    tic
    [sim_data.coeff(:,i),fval,exitFlag1,Foutput]  = fmincon(@(k)k(end),[sim_data.coeff(:,i);sim_data.T],[],[],[],[],[],[],@(k)FindOptimalCoefficientsAndTime(k,cdpr_p,cdpr_v,...
