classdef UtilitiesType
  properties
    ...
    fsolve_options = optimoptions('fsolve', 'Algorithm',...
      'levenberg-marquardt', 'FunctionTolerance', 1e-8,...
      'MaxFunctionEvaluation', 1000000, 'MaxIterations', 1000000,...
      'OptimalityTolerance', 1e-1, 'StepTolerance', 1e-8, 'UseParallel', true);
    fsolve_options_grad = optimoptions('fsolve','Algorithm',...
      'levenberg-marquardt', 'FunctionTolerance', 1e-8,...
      'MaxFunctionEvaluation', 1000000, 'MaxIterations', 1000000,...
      'OptimalityTolerance', 1e-8, 'display', 'none', 'StepTolerance',...
      1e-8, 'SpecifyObjectiveGradient', true, 'UseParallel', true);
    lsqnonlin_options = optimoptions('lsqnonlin', 'Algorithm',...
      'trust-region-reflective', 'FunctionTolerance', 1e-6,...
      'MaxFunctionEvaluation', 1000000, 'MaxIterations', 1000000,...
      'OptimalityTolerance', 1e-6, 'StepTolerance', 1e-6, 'UseParallel', true);
    lsqnonlin_options_grad = optimoptions('lsqnonlin', 'Algorithm',...
      'levenberg-marquardt', 'FunctionTolerance', 1e-6,...
      'MaxFunctionEvaluation', 1000000, 'MaxIterations', 1000000,...
    ...
    fmincon_options = optimoptions('fmincon', 'Algorithm', 'interior-point',...
      ...
      'MaxIterations', 1000000, 'OptimalityTolerance', 1e-8,...
      'StepTolerance', 1e-8);
    huen_c = [0; 1];
    huen_b = [1/2; 1/2];
    huen_M = [0 0 ;
