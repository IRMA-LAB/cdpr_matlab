classdef CdprVar
  ...
  properties
    platform = PlatformVar % an object containing time dependent variables of the platform.
    cable = CableVar % an object containing time dependent variables of a cable and its swivel pulley.
    ...
    D_mat % a matrix (size[3,3]) that transforms the 1th order derivatives of rotation angles to angular velocity.
