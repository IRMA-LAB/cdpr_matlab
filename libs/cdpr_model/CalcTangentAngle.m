...
%CALCTANGENTANGLE computes the supplementary of the wrapped angle of the cable
...
s = dot(vers_u, pos_DA_glob);
app_v = dot(vers_k, pos_DA_glob) / s;
angle = 2. * atan(app_v + sqrt(1 - 2. * sw_r / s + app_v * app_v));
