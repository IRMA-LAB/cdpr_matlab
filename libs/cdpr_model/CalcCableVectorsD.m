...
%CALCCABLEVECTORSD computes the 1th order derivative of vectors linked to cable
% and swivel pulley geometry.
%
...
cable_v.vers_n_deriv = cable_v.vers_w .* cos(cable_v.tan_ang) .*...
  cable_v.swivel_ang_vel - cable_v.vers_t .* cable_v.tan_ang_vel;
cable_v.vers_t_deriv = cable_v.vers_w .* sin(cable_v.tan_ang) .*...
  cable_v.swivel_ang_vel + cable_v.vers_n .* cable_v.tan_ang_vel;
