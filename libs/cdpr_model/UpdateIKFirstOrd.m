...
%UPDATEIKFIRSTORD updates time dependent variables connected to the 1th order
% inverse kinematics problem of the cdpr.
%
...
for i = 1:length(cdpr_v.cable)
  cdpr_v.cable(i) = UpdateCableFirstOrd(cdpr_p.cable(i), cdpr_v.platform,...
    cdpr_v.cable(i));
end
