...
%   cable and its swivel pulley.
  ...
  cable_v.swivel_ang_acc = CalcSviwelAngleD2(cable_v.vers_u,cable_v.vers_w,...
    cable_v.vers_w_deriv,cable_v.vel_OA_glob,cable_v.acc_OA_glob,cable_v.pos_DA_glob);
  ...
  cable_v.complete_acceleration = CalcCableAcceleration(cable_v.vers_t,cable_v.vers_t_deriv,cable_v.vel_OA_glob,cable_v.acc_OA_glob);
