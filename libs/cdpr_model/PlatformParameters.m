...
%     
  properties 
    ...
    ext_moments_glob;% is a vector (size[3,1], [Nm]), containing the components of the external moments acting on the platform, about the center of mass G, projected in the local frame.             
...
%   parameters, arranged in different fields. 
      ...
      obj.ext_moments_glob = platform_parameters_struct.ext_moments_loc;
    end
  end
end