function [vector, matrix] = FunDkGsSwL(cdpr_p, complete_length, ...
  swivel_angles, variables, varargin)
...
gs_constraint = cdpr_v.underactuated_platform.geometric_orthogonal' *...
  cdpr_v.platform.ext_load;
