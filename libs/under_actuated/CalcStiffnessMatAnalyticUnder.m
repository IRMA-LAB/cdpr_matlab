function matrix = CalcStiffnessMatAnalyticUnder(cdpr_v)
...
matrix = -cdpr_v.underactuated_platform.analitic_orthogonal'*cdpr_v.D_mat'*K*cdpr_v.D_mat*cdpr_v.underactuated_platform.analitic_orthogonal;
