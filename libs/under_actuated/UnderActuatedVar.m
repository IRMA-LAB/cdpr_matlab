classdef UnderActuatedVar
  ...
  methods
    ...
    function obj = UpdateGeometricTauJacobian(obj)
      obj.geometric_tau = obj.geometric_parallel' *...
        linsolve(obj.geometric_orthogonal * obj.geometric_orthogonal',...
        obj.geometric_orthogonal);
    end
    ...
    function obj = UpdateAnaliticTauJacobian(obj)
      obj.analitic_tau =  obj.analitic_parallel' *...
        linsolve(obj.analitic_orthogonal * obj.analitic_orthogonal',...
        obj.analitic_orthogonal);
    end
