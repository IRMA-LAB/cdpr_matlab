classdef UtilitiesType
    properties
        ...
        fsolve_options = optimoptions('fsolve','Algorithm',...
            ...
            'StepTolerance',1e-5,'UseParallel',true);
        fsolve_options_nopar = optimoptions('fsolve','Algorithm',...
            'levenberg-marquardt','FunctionTolerance',1e-6,'MaxFunctionEvaluation',...
            1000000,'MaxIterations',1000000,'OptimalityTolerance',1e-6,...
            'StepTolerance',1e-5,'UseParallel',false);
        brutal_fsolve_options = optimoptions('fsolve','Algorithm',...
            'levenberg-marquardt','FunctionTolerance',1e-2,'MaxFunctionEvaluation',...
            1000,'MaxIterations',100,'OptimalityTolerance',1e-1,...
        ...
        fsolve_options_grad = optimoptions('fsolve','Algorithm',...
            ...
            1000,'MaxIterations',1000,'OptimalityTolerance',1e-8,...
            'StepTolerance',1e-8,'SpecifyObjectiveGradient',true,'UseParallel',true,'Display','none');
%  fsolve_options_grad = optimoptions('fsolve','Algorithm',...
%             'levenberg-marquardt','FunctionTolerance',1e-8,'MaxFunctionEvaluation',...
...
%             'StepTolerance',1e-8,'SpecifyObjectiveGradient',true,'UseParallel',true);
        ...
        fmincon_options = optimoptions('fmincon','Algorithm','interior-point',...
            ...
            'MaxIterations',1000000,'OptimalityTolerance',1e-6,'StepTolerance',1e-8,'UseParallel',true,'ConstraintTolerance',1e-6);
        extreme_fmincon_options = optimoptions('fmincon','Algorithm','interior-point',...
        ...
        brutal_fmincon_options = optimoptions('fmincon','Algorithm','interior-point',...
        ...
        brutal_fmincon_options_nopar = optimoptions('fmincon','Algorithm','interior-point',...
            'FunctionTolerance',1e-2,'MaxFunctionEvaluation',1000,...
            'MaxIterations',100,'OptimalityTolerance',1e-2,'StepTolerance',1e-3,'UseParallel',false,'ConstraintTolerance',1e-3);
        no_par_fmincon_options = optimoptions('fmincon','Algorithm','interior-point',...
            'FunctionTolerance',1e-8,'MaxFunctionEvaluation',1000000,...
            'MaxIterations',1000000,'OptimalityTolerance',1e-6,'StepTolerance',1e-8,'ConstraintTolerance',1e-14);
        fmincon_options_grad = optimoptions('fmincon','Algorithm','interior-point',...
            'FunctionTolerance',1e-8,'MaxFunctionEvaluation',1000000,...
        ...
        bvp_options = bvpset('RelTol',1e-5,'Stats','off','AbsTol',1e-8,'NMax',1000); 
        huen_c = [0;1];
        huen_b = [1/2;1/2];
        huen_M = [0 0 ;
            1 0];
